...
subtitle: "A modification of Emi Tanaka example"
author: "John Minter"
date: "June 29, 2018"
output:
...
<br><br>
# .textshadow[Making a Shiny interactive web application using `r anicon::faa("r-project", size=2, animate="pulse")`]
<br><br>
...
.header[How to get started with shiny?]
...
.header[There are two types of shiny developers]
